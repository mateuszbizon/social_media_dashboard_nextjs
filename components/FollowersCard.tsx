...
function FollowersCard({ socialData }: FollowersCardProps) {
	return (
		<div className='w-[300px] bg-card-background-color rounded-lg'>
			...
			<div className='flex flex-col gap-4 py-7'>
				...
				<div className='flex flex-col gap-2 items-center'>
					<span className='text-main-color font-bold text-5xl'>{socialData.followers}</span>
					<span className='text-secondary-color uppercase'>{socialData.followersType}</span>
				</div>
				<div className='flex justify-center items-center gap-2'>
					<Image
						src={socialData.isIncreasing ? "/images/icon-up.svg" : "/images/icon-down.svg"}
						width={12}
						height={12}
